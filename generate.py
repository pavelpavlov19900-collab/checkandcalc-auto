...
try:
   ...
   # 2. ГЕНЕРИРАНЕ (С УЛТРА-ЕВТИН FLASH + FALLBACK ЗАЩИТА + ГЕО + 400 ДУМИ)
    ...
    attempts_config = [
        ('gemini-2.5-flash-8b', 0),     # Опит 1: Веднага (0 сек)
        ('gemini-2.5-flash-8b', 43),    # Опит 2: След 43 сек 
        ('gemini-2.5-flash-8b', 137),   # Опит 3: След 2 мин и 17 сек
        ('gemini-2.5-flash-8b', 311),   # Опит 4: След 5 мин и 11 сек
        ('gemini-2.5-flash-8b', 613),   # Опит 5: След 10 мин и 13 сек
